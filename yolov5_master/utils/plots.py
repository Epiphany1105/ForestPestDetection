...
def plot_one_box(x, im, color=None, label=None, line_thickness=3):
    ...
    # c11, c22 = (int(x[0]), int(x[1]) + 150), (int(x[2]), int(x[3]) + 150)
    ...
    if label:
        ...
        cv2.rectangle(im, (c1[0] - 2, c1[1] - 2), c2, color, -1, cv2.LINE_AA)  # filled
        cv2.putText(im, label, (c1[0] - 2, c1[1] - 2), 0, tl / 6, [225, 255, 255], thickness=1, lineType=cv2.LINE_AA)
        # cv2ImgAddText(im, label, c1[0], c1[1], (255, 255, 255), 100)
